...
(function () {
  ...
  const routes = [
    ...
    { motif: /^\/espace-coach\/portefeuille$/, page: "coachPortefeuille", shell: "dash", role: "coach" },
  ...
  function sidebarPour(role, routeActive) {
    ...
    if (role === "coach") {
      ...
      return CL.layout.sidebar("Espace coach", [
        ...
        { href: "#/espace-coach/portefeuille", icone: "portefeuille", label: "Portefeuille" },
  ...
  function init() {
    ...
    if (CL.API && CL.API.actif) {
      ...
      CL.abonnementService && CL.abonnementService.verifierRenouvellements && CL.abonnementService.verifierRenouvellements();
    }
