...
TaskFlow est entièrement optimisé pour les smartphones et tablettes :

- ✅ **Design responsive** (mobile-first) avec breakpoints adaptés (768px, 480px, 380px)
- ✅ **Menu hambourgeois** automatique sur petits écrans
- ✅ **Progressive Web App (PWA)** installable sur l'écran d'accueil
- ✅ **Service Worker** pour support offline et mise en cache intelligente
- ✅ **Interactions tactiles natives** : hit targets ≥44px, clavier optimisé, safe-area support
- ✅ **Performance maximale** : LCP < 3s, CLS < 0.1
- ✅ **Support notches/encoches** iOS et Android

→ **Voir [MOBILE_OPTIMIZATION.md](./MOBILE_OPTIMIZATION.md) pour les détails techniques**
