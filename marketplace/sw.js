...
self.addEventListener("fetch", (e) => {
  ...
  if (url.indexOf("/api/") !== -1 || url.indexOf("/verify") !== -1 || url.indexOf("/admin/") !== -1 || url.indexOf("/mes-commandes") !== -1 || url.indexOf("/mes-ventes") !== -1 || url.indexOf("/paiement") !== -1 || url.indexOf("/facture") !== -1) return;
